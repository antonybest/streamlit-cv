...
working extensively with **Snowflake** and **dbt** to create multi-layered data architectures. My technical expertise 
includes designing sophisticated intermediate models that handle complex joins across student information systems, 
learning management platforms, and video analytics data. I implement advanced SQL techniques including window functions 
and data aggregation strategies, and hold certifications in **Snowflake SnowPro** and **Azure AZ-900**. I develop 
comprehensive data models that support real-time analytics dashboards and API endpoints, enabling stakeholders to 
access critical insights for student success and institutional decision-making.
"""
...
experience = [
    {
        ...
        "details": [
            "Designed and built end-to-end data platforms using Snowflake, Azure Data Factory, and dbt",
            "Delivered scalable ELT solutions integrating multiple data systems into unified warehouse",
            "Built Azure Functions with APIM APIs for cloud-native automation",
            "Collaborated with stakeholders to deliver data strategies aligned with business goals"
        ]
    },
    {
        "role": "Data Engineer | Capgemini UK (05/2023 – 04/2024)",
        "details": [
            "Processed XML data in AWS Glue, loading structured data into AWS and Snowflake",
    ...
    },
    {
        ...
        "details": [
            ...
            "Modelled data from unstructured sources using Insomnia and DBeaver"
        ]
    },
    {
    ...
    },
    {
        ...
        "details": [
            "Analysed CSV data using Python, Pandas, Seaborn, and Matplotlib"
        ]
    },
]
...
if REPORTLAB_AVAILABLE:
    ...
    # Compact styling optimized for single page
    ...
    styles.add(ParagraphStyle(name='CVListItem', fontSize=8, leading=10, leftIndent=15, fontName='Helvetica'))
    ...
    styles.add(ParagraphStyle(name='CVSummary', fontSize=8, leading=10, spaceAfter=4, fontName='Helvetica'))
